...
# Upnext is a YouTube playlist builder, which will remove old videos and add new videos to a specified playlist, based on channel subscription choices that you specify.
...
while True:
    ...
    # main menu
    print('\nUpnext - YouTube Playlist Builder\n')
    print('Main Menu')
    try:
            ...
            for name in channel_names:    
                ...
                if name.text in subs_to_keep:
                    ...
                    # adds videos that haven't been watched to playlist
                        ...
                        browser.find_element_by_xpath(playlist_name_path).click()
                        time.sleep(1)
    ...
    if menu_choice == '4':
        ...
        while True:
            ...
            if playlist_settings_choice in ('1', '0'):
                break
            print('\nInvalid input. Please enter a valid menu option')
